...
/******/ 		}
/******/ 		script.src = __webpack_require__.p + "" + ({"0":"js/navimain","1":"js/loginpage","2":"js/welcome"}[chunkId]||chunkId) + ".js";
...
var _vueSession = __webpack_require__("./node_modules/vue-session/index.js");
...
var _vueResource = __webpack_require__("./node_modules/vue-resource/dist/vue-resource.esm.js");

var _vueResource2 = _interopRequireDefault(_vueResource);

var _vueLocalstorage = __webpack_require__("./node_modules/vue-localstorage/dist/vue-local-storage.js");
...
var _user = __webpack_require__("./resources/js/store/user.js");

var _user2 = _interopRequireDefault(_user);

var _session = __webpack_require__("./resources/js/store/session.js");
...
var baseurl = "http://cenith.local";

var storeAll = new _vuex2.default.Store({
    state: {
        _IsLogin: false,
        _UserId: ""
    },
...
var welcome = function welcome() {
    return __webpack_require__.e/* import() */(2).then(__webpack_require__.bind(null, "./resources/js/components/Welcome.vue"));
};
var menumain = function menumain() {
    return __webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, "./resources/js/components/navi/Menumain.vue"));
};
var loginpage = function loginpage() {
    return __webpack_require__.e/* import() */(1).then(__webpack_require__.bind(null, "./resources/js/components/login/LoginPage.vue"));
};
...
new _vue2.default({
    ...
    beforeCreate: function beforeCreate() {
        ...
        .get(baseurl + '/xlr').then(function (response) {
            if (response.data.IsSession == 1) _this.$store.state._IsLogin = true;else _this.$store.state._IsLogin = false;
...
exports.default = {
    ...
    getters: {
        getUserLogin: function getUserLogin(state, getters, rootState) {
    ...
    actions: {
        fetchLoginDetails: function fetchLoginDetails(_ref) {
